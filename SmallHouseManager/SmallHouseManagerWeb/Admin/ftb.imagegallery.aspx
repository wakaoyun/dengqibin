...
<body>
    ...
    <form id="Form1" runat="server" enctype="multipart/form-data">     
		<FTB:ImageGallery id="ImageGallery1" 
			...
			AllowImageDelete="false" AllowImageUpload="true" AllowDirectoryCreate="true" AllowDirectoryDelete="false" runat="Server" CurrentImagesFolder="~/AdsImages" RootImagesFolder="~/AdsImages" />
